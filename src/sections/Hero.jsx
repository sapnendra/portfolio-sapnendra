...
const Hero = () => {
  ...
  return (
    <>
      ...
      >
        {/* Text container — use div, not header (the nav is the header landmark) */}
        <div className="main-container h-screen flex flex-col lg:justify-center items-start lg:py-12 max-lg:pt-40">
          ...
          {/* Proper semantic h2 instead of p with role="heading" */}
          <h2 className="hero-tagline text-6xl lg:text-[8vw] font-heading font-bold leading-[1] tracking-tight mt-3 mb-6">
            Full Stack <br />
            Web<span className="text-5vh text-stroke"> Devv. </span>
          </h2>
          <GradientButton
            text="Let's Talk"
            link="mailto:sapnendrajaiswal2388@gmail.com"
            className="gradient-btn"
          />
        </div>

        {/* Decorative star shape — hidden from assistive tech */}
        <div
          className="star absolute -z-1 top-80 lg:top-32 right-[-35%] lg:right-[-12%] opacity-80"
          aria-hidden="true"
        >
          <svg
