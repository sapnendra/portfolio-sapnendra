...
const Footer = () => {
  return (
    <>
      {/* Divider */}
      <div
        className="max-w-[1500px] m-auto h-[1px] bg-white opacity-10"
        aria-hidden="true"
      ></div>

      {/* Footer Top */}
      <footer className="main-container grid md:grid-cols-2 lg:grid-cols-4 gap-10 py-20">
        {/* Logo - use span, not h1 (footer logo is not a page heading) */}
        <Link to="/" aria-label="Back to home">
          <span className="text-4xl font-bold font-heading md:w-56 w-56 block">
            SAPNENDRA
          </span>
        </Link>

        <div>
          <h2 className="font-medium mb-5 text-base lg:text-lg uppercase tracking-wide">
            Services
          </h2>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-base lg:text-lg">
            <li>
              ...
              >
                sapnendrajaiswal2388@gmail.com
              </a>
            </li>
            <li>
              <a
                href="tel:+919685238884"
      ...
      {/* Divider */}
      <div
        className="max-w-[1500px] m-auto h-[1px] bg-white opacity-20"
        aria-hidden="true"
      ></div>
      ...
      <div className="main-container grid md:grid-cols-2 gap-3 py-6 lg:py-8 max-md:text-center">
        <div className="text-base lg:text-lg">
          <small>© 2025 Sapnendra — All rights reserved</small>
        </div>
        <nav
        ...
        >
          <a
            href="https://www.linkedin.com/in/sapnendra/"
          ...
          <a
            href="https://facebook.com/sapnendra"
